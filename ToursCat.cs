namespace mis221_pa5_Dnsavage
{
    public class ToursCat
    {
        ...
        //No args constructor for ToursCat
        public ToursCat()
        {

        }
        //Constructor for ToursCat
        public ToursCat(string name, string spent, string rating)
        {
            this.name = name;
            this.spent = spent;
            this.rating = rating;
        ...
        {
            ToursCat.totSpentCat = totSpentCat;
        }
