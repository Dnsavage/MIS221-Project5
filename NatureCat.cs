namespace mis221_pa5_Dnsavage
{
    public class NatureCat
    {
        ...
        //No args constructor for NatureCat
        public NatureCat()
        {

        }
        //Constructor for NatureCat
        public NatureCat(string name, string spent, string rating)
        {
            this.name = name;
            this.spent = spent;
            this.rating = rating;
        ...
        {
            NatureCat.totSpentCat = totSpentCat;
        }
